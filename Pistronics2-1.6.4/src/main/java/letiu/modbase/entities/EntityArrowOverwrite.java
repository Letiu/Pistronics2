...
public class EntityArrowOverwrite extends BaseEntity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityArrowOverwrite(World par1World)
    {
        super(par1World);
    ...
    public EntityArrowOverwrite(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityArrowOverwrite(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityArrowOverwrite(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                    	// PISTRONICS: Changed to causeThrownDamage()
                    ...
                    // PISTRONICS: Save Entity NBT before it dies
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)i1))
                    {
                        if (movingobjectposition.entityHit instanceof EntityLivingBase)
                        {
                            ...
                            // PISTRONICS: Handle Entity being hit
                            onEntityLivingHit(entitylivingbase, nbt);
    ...
    // PISTRONICS: Overwrite this
    protected void onEntityLivingHit(EntityLivingBase entity, NBTTagCompound nbt) {		
	}
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            ItemStack stack = getStackOnPickup();
            
            boolean myFlag = par1EntityPlayer.inventory.addItemStackToInventory(getStackOnPickup());
