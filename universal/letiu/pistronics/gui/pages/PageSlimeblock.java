...
public class PageSlimeblock extends Page {
	...
	public boolean isInfoAbout(World world, int x, int y, int z) {
		...
		return block != null && block instanceof BSlimeblock;
	}
	...
	public void draw(GuiBookOfGears book, int x, int y) {
		...
		book.drawString(x + 22, y + 18, 100, 1F, "Slimeblocks");
		book.drawLine(x + 22, y + 24);
		book.drawFramedStack(BlockItemUtil.getStack(BlockData.slimeBlock), x + 22, y + 30, 1.8F);
		
		String text1 = "Slimeblocks are as you would expect sticky on all side. There is no";
