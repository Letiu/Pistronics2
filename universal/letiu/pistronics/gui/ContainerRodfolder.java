...
public class ContainerRodfolder extends Container {
	
	protected TileRodFolder tile;

    public ContainerRodfolder (InventoryPlayer inventoryPlayer, TileRodFolder tile){
	    this.tile = tile;
	    
	    for (int i = 0; i < 5; i++) {
            addSlotToContainer(new Slot((IInventory) tile.tileEntity, i, 44 + i * 18, 35));
    ...
    public boolean canInteractWith(EntityPlayer player) {
    	return tile.getPInventory().isUseableByPlayer(player);
    }
