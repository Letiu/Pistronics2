...
public class EntityPetrifyArrowRenderer extends UniversalEntityRenderer {
	
	private static final ResourceLocation arrowTextures = new ResourceLocation("textures/entity/arrow.png");
	
	@Override
	public void renderEntity(Entity entity, double x, double y, double z, float var8, float par9) {
        ...
        float f11 = (float)((EntityPetrifyArrow) entity).arrowShake - par9;
